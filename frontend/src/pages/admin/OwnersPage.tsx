...
import { blockOwner, fetchOwners } from '../../services/apis/adminApi';
...
const OwnersPage = () => {
  ...
  useEffect(() => {
    const fetchOwnerData = async () => {
      try {
        setLoading(true);
        // Update the fetchOwners function to accept searchTerm parameter
        const result = await fetchOwners(currentPage, limit, debouncedSearchTerm);
  ...
  const LoadingSpinner = () => (
    <div className="flex flex-col items-center justify-center h-64">
      ...
      <p className="mt-2 text-sm text-gray-500">Loading owners data...</p>
    </div>
  );
      ...
      <div className="lg:ml-64 min-h-screen">
        <div className="p-4 lg:p-8">
          ...
          <div className="mb-4 lg:mb-6">
            <h1 className="text-xl lg:text-2xl font-bold text-gray-800 mt-12 lg:mt-0">Owners Management</h1>
          </div>

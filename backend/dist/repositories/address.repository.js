...
let AddressRepository = class AddressRepository extends base_repository_1.BaseRepository {
    ...
    addNewAddress(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._addressModel.create(data);
        });
    }
    ;
    getUserAddresses(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._addressModel.find({ userId: userId });
        });
    }
    ;
};
AddressRepository = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.default.AddressModel)),

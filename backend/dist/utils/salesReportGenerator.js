...
exports.generateSalesReportPDF = void 0;
 ...
 */
const generateSalesReportPDF = (res, salesData, reportParams) => {
    try {
        ...
        const addTableRow = (label, amount, fillColor) => {
            doc
...
exports.generateSalesReportPDF = generateSalesReportPDF;
